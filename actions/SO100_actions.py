...
class SO100Actions(RobotActions):
    def __init__(self):
        ...
        print(f"SO100Actions initialized with init_pose: {self.init_pose}, gripper_open: {self.gripper_open}, gripper_close: {self.gripper_close}")
    ...
    def pick_and_place(self, pick_entity: Entity, place_entity: Entity):
        low_level_actions = [
            {"function": "go_high", "params": [pick_entity, self.gripper_open], "entity": pick_entity, "tracking": False},
            {"function": "go_low", "params": [pick_entity, self.gripper_open], "entity": pick_entity, "tracking": False},
            ...
            {"function": "go_mid", "params": [place_entity, self.gripper_close], "entity": place_entity, "tracking": False},
            {"function": "go_mid", "params": [place_entity, self.gripper_open], "entity": place_entity, "tracking": False},
            {"function": "go_high", "params": [place_entity, self.gripper_open], "entity": place_entity, "tracking": False},
            {"function": "go_init", "params": [], "entity": place_entity, "tracking": False},
        ]
